...
window.jQuery = function (selectorOrArrayOrTemplate) {
  ...
  // api 可以操作elements
  var api = Object.create(jQuery.prototype); //创建一个对象，这个对象的__proto__为括号里面的东西，相当于const api = {__proto__:jQuery,prototype}
...
jQuery.fn = jQuery.prototype = {
  ...
  children: function children() {
    ...
    this.each(function (node) {
      ...
      array.push.apply(array, _toConsumableArray(node.children)); //等于array.push(node.children[1],node.children[2],node.children[3]...)
    });
    return jQuery(array);
  },
  siblings: function siblings() {
    ...
    this.each(function (node) {
      ...
      array.push(Array.from(node.parentNode.children).filter(function (n) {
        return n !== node;
      }));
    });
    return jQuery(array);
...
//# sourceMappingURL=/jquery.ddfdfa54.map