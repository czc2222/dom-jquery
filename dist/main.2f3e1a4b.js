...
api.addClass('red').addClass('blue').addClass('green'); //遍历所有刚才获取的元素，添加.red,由于for循环中return了api 后面继续添加addClass是链式操作
jQuery('.test').find('.child').addClass('black').addClass('yellow') //下面的简化
.end().addClass('pink');
...
var c2 = api.find('.child2');
c2.siblings().print();
c2.next().print();
c2.previous().print();

var $div = $('<div>添加div</div>');
...
//# sourceMappingURL=/main.2f3e1a4b.map